  ...
  if (currentUser) {
    ...
    if (mobileUserCard) {
      ...
      mobileUserCard.innerHTML = `
        ...
        <button type="button" class="btn-logout-mobile" onclick="logoutUser()" title="Đăng xuất" style="margin-left:auto; background:none; border:none; color:#ef4444; font-size:16px; padding:6px; cursor:pointer;">
    ...
    if (mobileUserCard) {
      mobileUserCard.innerHTML = `
        ...
        <div class="m-user-info">
          <div class="m-user-name" style="font-size:13px;">Khách hàng 7Dbio</div>
          <div class="m-user-status" style="font-size:11px;">Đăng nhập để nhận giá sỉ</div>
        </div>
